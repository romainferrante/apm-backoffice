...
import fr.cnp.apm.bo.config.Constants;
import fr.cnp.apm.bo.domain.Authority;
import fr.cnp.apm.bo.domain.User;
import fr.cnp.apm.bo.repository.AuthorityRepository;
import fr.cnp.apm.bo.repository.UserRepository;
import fr.cnp.apm.bo.security.AuthoritiesConstants;
import fr.cnp.apm.bo.service.MailService;
import fr.cnp.apm.bo.service.UserService;
import fr.cnp.apm.bo.service.dto.PasswordChangeDTO;
import fr.cnp.apm.bo.service.dto.UserDTO;
import fr.cnp.apm.bo.web.rest.errors.ExceptionTranslator;
import fr.cnp.apm.bo.web.rest.vm.KeyAndPasswordVM;
import fr.cnp.apm.bo.web.rest.vm.ManagedUserVM;
