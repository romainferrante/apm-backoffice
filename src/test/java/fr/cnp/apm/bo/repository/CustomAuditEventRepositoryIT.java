...
import fr.cnp.apm.bo.config.audit.AuditEventConverter;
import fr.cnp.apm.bo.domain.PersistentAuditEvent;
...
import static fr.cnp.apm.bo.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
